-- Validacion operativa del piloto CDC para src.t117_compradores
...
SELECT
    ...
    updated_at
FROM etl.cdc_state
WHERE config_name = 'pilot_t117_compradores';
...
ORDER BY fecha_extraccion DESC NULLS LAST, c_comprador
LIMIT 50;
