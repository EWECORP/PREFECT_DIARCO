-- Validacion operativa del piloto CDC para src.t020_proveedor_dias_entrega_cabe
...
SELECT
    ...
    updated_at
FROM etl.cdc_state
WHERE config_name = 'pilot_t020_proveedor_dias_entrega_cabe';
...
ORDER BY fecha_extraccion DESC NULLS LAST, c_proveedor
LIMIT 50;
