...
VALUES (
    'pilot_t020_proveedor_dias_entrega_cabe',
    '192.168.0.11',
    'DiarcoP',
    'dbo',
    'T020_PROVEEDOR_DIAS_ENTREGA_CABE',
    'dbo_T020_PROVEEDOR_DIAS_ENTREGA_CABE',
    'SQLP_DRIVER',
    'SQLP_PORT',
    'SQLP_USER',
    'SQLP_PASSWORD',
    ...
    300,
    5000,
    'Octava tabla piloto CDC SQL Server -> PostgreSQL para T020_PROVEEDOR_DIAS_ENTREGA_CABE'
)
