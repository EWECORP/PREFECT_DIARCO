...
VALUES (
    'pilot_t020_proveedor_dias_entrega_deta',
    '192.168.0.11',
    'DiarcoP',
    'dbo',
    'T020_PROVEEDOR_DIAS_ENTREGA_DETA',
    'dbo_T020_PROVEEDOR_DIAS_ENTREGA_DETA',
    'SQLP_DRIVER',
    'SQLP_PORT',
    'SQLP_USER',
    'SQLP_PASSWORD',
    'src',
    't020_proveedor_dias_entrega_deta',
    ARRAY['c_proveedor', 'c_sucu_empr', 'c_articulo'],
    true,
    'cdc',
    300,
    5000,
    'Novena tabla piloto CDC SQL Server -> PostgreSQL para T020_PROVEEDOR_DIAS_ENTREGA_DETA'
)
