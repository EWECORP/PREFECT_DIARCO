...
VALUES (
    'pilot_t052_articulos_proveedor',
    '192.168.0.11',
    'DiarcoP',
    'dbo',
    'T052_ARTICULOS_PROVEEDOR',
    'dbo_T052_ARTICULOS_PROVEEDOR',
    'SQLP_DRIVER',
    'SQLP_PORT',
    'SQLP_USER',
    'SQLP_PASSWORD',
    'src',
    't052_articulos_proveedor',
    ARRAY['c_proveedor', 'c_articulo'],
    true,
    'cdc',
    300,
    5000,
    'Tercer piloto CDC SQL Server -> PostgreSQL para T052_ARTICULOS_PROVEEDOR'
)
