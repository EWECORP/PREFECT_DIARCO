-- Validacion operativa del piloto CDC para src.t085_articulos_ean_edi
...
SELECT
    ...
    updated_at
FROM etl.cdc_state
WHERE config_name = 'pilot_t085_articulos_ean_edi';
...
ORDER BY fecha_extraccion DESC NULLS LAST, c_articulo, c_ean
LIMIT 50;
