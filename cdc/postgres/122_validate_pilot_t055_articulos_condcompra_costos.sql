-- Validacion operativa del piloto CDC para src.t055_articulos_condcompra_costos
...
SELECT
    ...
    updated_at
FROM etl.cdc_state
WHERE config_name = 'pilot_t055_articulos_condcompra_costos';
...
ORDER BY fecha_extraccion DESC NULLS LAST, c_proveedor, c_articulo, c_sucu_empr
LIMIT 50;
