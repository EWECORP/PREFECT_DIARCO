-- Validacion operativa del piloto CDC para src.t052_articulos_proveedor
...
SELECT
    ...
    updated_at
FROM etl.cdc_state
WHERE config_name = 'pilot_t052_articulos_proveedor';
...
ORDER BY fecha_extraccion DESC NULLS LAST, c_proveedor, c_articulo
LIMIT 50;
