-- Validacion operativa del piloto CDC para src.t055_articulos_param_stock
...
SELECT
    ...
    updated_at
FROM etl.cdc_state
WHERE config_name = 'pilot_t055_articulos_param_stock';
...
ORDER BY fecha_extraccion DESC NULLS LAST, c_sucu_empr, c_clasificacion_compra, c_familia, c_rubro
LIMIT 50;
