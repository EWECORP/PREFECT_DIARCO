-- Validacion operativa del piloto CDC para src.t100_empresa_suc
...
SELECT
    ...
    updated_at
FROM etl.cdc_state
WHERE config_name = 'pilot_t100_empresa_suc';
...
ORDER BY fecha_extraccion DESC NULLS LAST, c_sucu_empr
LIMIT 50;
