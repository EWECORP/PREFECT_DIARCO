...
sqlserver_bases = {
    "data-sync": f"mssql+pyodbc://{SQL_USER}:{SQL_PASSWORD}@{SQL_SERVER}/DIARCOP001.data-sync.dbo.?driver=ODBC+Driver+17+for+SQL+Server",
}
...
tablas = [
    ("DiarcoEst", "[DCO-DBCORE-P02].[DiarcoEst].[dbo].T702_EST_VTAS_POR_ARTICULO", "F_VENTA >= '20230101'"),
    ("DiarcoP", "[DIARCOP001].[DiarcoP].[dbo].T050_ARTICULOS", "M_BAJA = 'N'"),
    ("DiarcoP", "[DIARCOP001].[DiarcoP].[dbo].T051_ARTICULOS_SUCURSAL", ""),
    ("DiarcoP", "[DIARCOP001].[DiarcoP].[dbo].T060_STOCK", ""),
    ("DiarcoP", "[DIARCOP001].[DiarcoP].[dbo].T080_OC_CABE", ""),
    ("DiarcoP", "[DIARCOP001].[DiarcoP].[dbo].T710_ESTADIS_REPOSICION", ""),
