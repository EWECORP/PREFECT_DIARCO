...
directorio_archivos_backup = '/sftp/archivos/usr_diarco/data-online/backup'
...
for archivo in os.listdir(directorio_archivos):
    if archivo.endswith(".csv"):
        ...
        try:
            ...
            for chunk in pd.read_csv(archivo_ruta, sep='|', encoding='latin1', header=None, low_memory=False, chunksize=chunksize, skiprows=1, dtype=str):
            ...
            traceback.print_exc()  # Esto imprimirá el detalle completo del error
            continue
