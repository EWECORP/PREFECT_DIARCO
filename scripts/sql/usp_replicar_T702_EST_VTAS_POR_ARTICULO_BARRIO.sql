...
/****** Object:  StoredProcedure [repl].[usp_replicar_T702_EST_VTAS_POR_ARTICULO_BARRIO]    Script Date: 22/08/2026 19:07:50 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
    ...
    BEGIN TRY
        ...
        SELECT @fecha_max = ISNULL(MAX(F_VENTA), '20250601') 
